		...
		<div class="col-lg-12">
			...
			<div class="panel panel-default">
                ...
                <div class="panel-body">
                	<table id="order_data" class="table table-bordered table-striped" style="font-size: 11px;">
                		<thead>
							<tr>
								<th>Id</th>
                    ...
                    <!-- PHP Blocks -->
							...
							<td align="center">
                            <a href="order_update.php?order_id=<?php echo $order_id; ?>" target="_blank" id="<?php echo $order_id;  ?>" class="btn btn-primary btn-sm"><i class="far fa-edit"></i></a>
							</td >
							<td align="center">
